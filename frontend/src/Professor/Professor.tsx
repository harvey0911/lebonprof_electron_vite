        ...
        <main className="p-10 min-w-0">
            <div className="flex flex-wrap justify-between items-center mb-12 gap-6">
                <div>
                    ...
                    <p className="text-slate-500 font-medium mt-1">{t('professor_directory')}</p>
                </div>
                ...
                <div className="flex gap-4 items-center">
                    <div className="relative">
                        ...
                        <input
                            type="text"
                            placeholder={t('search_professors')}
                    ...
                    >
                        <Plus className="w-5 h-5" /> {t('add_professor')}
                    </button>
                </div>
            </div>
            ...
            <div className="space-y-4 max-w-5xl">
                ...
                {filteredProfessors.length === 0 && (
                    <div className="text-center py-20 bg-white rounded-[3rem] border-2 border-dashed border-slate-100">
                        <p className="text-slate-400 font-medium">{t('no_professors_found')}</p>
                    </div>
                )}
            </div>
                ...
                <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-md z-[100] flex items-center justify-center p-4">
                    <div className="bg-white rounded-[2.5rem] w-full max-w-md shadow-2xl p-8 animate-in zoom-in duration-300">
                        <div className="flex justify-between items-center mb-8">
                            <h3 className="text-2xl font-black text-slate-900">{t('new_professor')}</h3>
