...
app.post('/addtask', (req, res) => {
    ...
    dbconnection.run(query, [Description], function (err) {
        if (err) {
...
app.put('/updatetask/:taskId', (req, res) => {
    ...
    dbconnection.run(query, [Description, Status, taskId], function (err) {
        if (err) {
...
app.delete('/deletetask/:taskId', (req, res) => {
    const { taskId } = req.params;
    console.log("Delete request received for ID:", taskId); // <--- DEBUG LOG
    ...
    dbconnection.run(query, [taskId], function (err) {
        if (err) {
            ...
            console.log(`Rows affected: ${this.changes}`); // <--- DEBUG LOG
...
app.delete('/deletecourse/:CourseID', (req, res) => {
    ...
    dbconnection.run(query, [CourseID], function (err) {
        if (err) {
